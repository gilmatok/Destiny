...
namespace Destiny.Maple.Characters
{
    public sealed class Character : MapObject, IMoveable, ISpawnable
    {
        ...
        public void Load()
        {
            using (DatabaseQuery query = Database.Query("SELECT * FROM characters WHERE character_id = @character_id", new MySqlParameter("character_id", this.ID)))
            {
                query.NextRow();
        ...
        public void Encode(OutPacket oPacket)
        {
            ...
            this.Stats.EncodeApperance(oPacket);
            oPacket.WriteByte();
