...
namespace Destiny.Maple.Characters
{
    public sealed class CharacterTrocks
    {
        ...
        public void Update(InPacket iPacket)
        {
            ...
            using (OutPacket oPacket = new OutPacket(ServerOperationCode.MapTransferResult))
            {
                oPacket
        ...
        public bool Use(int itemID, InPacket iPacket)
        {
            bool used = false;
            ...
            else if (action == 1) // NOTE: IGN.
            {
                ...
                Character target = this.Parent.Client.Channel.Characters.GetCharacter(targetName);
            ...
            if (destinationMapID != -1)
            {
                ...
                Map destinationMap = this.Parent.Client.Channel.Maps[destinationMapID];
