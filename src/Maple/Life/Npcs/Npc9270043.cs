...
{
    public sealed class Npc9270043 : Npc
    {
        public Npc9270043(Datum datum) : base(datum) { }
        ...
        public override async Task Converse(Character talker)
        {
            ...
            {
                int choice = await this.ShowChoiceDialog(talker, "Welcome to the #m" + talker.Map.MapleID + "# Gachapon. How may I help you?", "What is Gachapon?", "here can you buy Gachapon tickets?");
                ...
                if (choice == 0)
                {
                    ...
                    await this.ShowNextDialog(talker, "You'll find a variety of items from the #m" + talker.Map.MapleID + "# Gachapon, but you'll most likely find several related items and scrolls since #m" + talker.Map.MapleID + "# is known as the town.");
                }
                else if (choice == 1)
                {
